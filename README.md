...
| POST /api/courses/create  | Add um novo course | CourseResponseDTO item  | Json do tipo Course |
| PUT /api/courses/status/{id}  | Atualiza o status de um course via id | StatusCourseEnum item  | Json do tipo Course |
| PUT /api/courses/update/{id}  | Atualiza um course | CourseResponseDTOitem  | Json do tipo Course |
